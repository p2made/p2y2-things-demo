...
class ThingsDemoAsset extends \p2m\base\assets\P2AssetBase
{
	protected $_p2mProjectId = 'p2y2-things-demo';

	private $assetData = [
		'published' => [
			'sourcePath' => '@vendor/p2made/p2y2-things-demo/assets/lib',
			'css' => [
...
//			'p2m\assets\P2CoreJsAsset',
	...
	{
		$this->configureAsset($this->assetData);
		parent::init();
	}
}
